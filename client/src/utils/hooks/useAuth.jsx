...
export const AuthProvider = ({ children }) => {
  ...
  const isSupervisor = useMemo(() => authenticated && user?.role?.name === ROLES.supervisor, [authenticated]);
  const isWaiting = useMemo(() => authenticated && user?.role?.name === ROLES.waiting, [authenticated]);
